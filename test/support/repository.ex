defmodule DomovoyGitPlugin.Test.Repository do
  @moduledoc """
  ...
  ```elixir
  repository = DomovoyGitPlugin.Test.Repository.create!()
  ...
  def create!(opts \\ []) do
    ...
    parent = Path.join(System.tmp_dir!(), "domovoy-git-#{unique_suffix()}")
