defmodule DomovoyGitPlugin.Test.NodeRunner do
  @moduledoc """
  ...
  ```elixir
  DomovoyGitPlugin.Test.NodeRunner.run(node, [
  ...
  def run(%Node{} = node, inputs) do
    ...
    root = Path.join(System.tmp_dir!(), "domovoy-git-plugin-#{job.id}")
